...
const FinalCtaSection = () => {
	...
	return (
		<section className='mx-auto max-w-[1440px] px-4 pb-0'>
			<div className='rounded-[44px] bg-primary-deepgreen px-6 pb-20 pt-16 shadow-sm md:px-10'>
				...
				<div className='mx-auto mt-14 max-w-[1200px] overflow-hidden rounded-[34px] bg-achromatic-0/10'>
					<div
